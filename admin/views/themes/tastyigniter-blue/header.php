<?php
	...
	$tastyigniter_logo  = base_url('views/themes/tastyigniter-blue/images/lugma-logo.png');
	$site_logo          = base_url('views/themes/tastyigniter-blue/images/lugma-logo.png');
