...
.bb-custom-wrapper::before,.bb-custom-wrapper::after{
    ...
    width:10px;
    height:100%;
    background:-webkit-linear-gradient(left,#000 33.33%,#f0f0f0 33.33%,#f0f0f0 66.66%,white 66.66%);
    background:linear-gradient(to right,#000 33.33%,#f0f0f0 33.33%,#f0f0f0 66.66%,white 66.66%);
...
.page-layout-3:last-child::before{
    left:0
}
.bb-custom-side::before{
    ...
    width:80px;
    height:100%;
    box-shadow:inset 50px 0 50px -20px rgba(0,0,0,0.5);
    content:''
}
.bb-custom-side:first-child::before{
    right:0;
    box-shadow:inset -1px 0 0 rgba(0,0,0,0.9),inset -50px 0 50px -20px rgba(0,0,0,0.5)
}
...
.page-layout-3:last-child{
    ...
    width:50%;
    height:100%;
    background:url(../../images/pattern/04.png) repeat top left
}
...
.no-csstransforms3d .book[data-book="book-1"],.no-js .book[data-book="book-1"],.book[data-book="book-1"] .front{
    background:-webkit-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),#262e35;
    background:-moz-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),#262e35;
    background:-ms-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),#262e35;
    background:-o-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),#262e35;
    background:linear-gradient(to right,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),#262e35;
    border-radius:0px 5px 5px 0px
}
...
.no-csstransforms3d .book[data-book="book-2"],.no-js .book[data-book="book-2"],.book[data-book="book-2"] .front{
    background:url(../img/cover2.html);
    background:-webkit-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),url(../img/cover2.html),#f6a7a5;
    background:-ms-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),url(../img/cover2.html),#f6a7a5;
    background:-moz-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),url(../img/cover2.html),#f6a7a5;
    background:-o-linear-gradient(left,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),url(../img/cover2.html),#f6a7a5;
    background:linear-gradient(to right,rgba(0,0,0,0.1) 0%,rgba(211,211,211,0.1) 5%,rgba(255,255,255,0.15) 5%,rgba(255,255,255,0.1) 9%,rgba(0,0,0,0.01) 100%),url(../img/cover2.html),#f6a7a5
}
#book-1{
    border-color:#009bdb;
    padding:0px 11px;
...
.book{
    ...
    -o-transition:-o-transform 0.5s,opacity 0.3s 0.3s;
    -ms-transition:-ms-transform 0.5s,opacity 0.3s 0.3s;
    -moz-transition:-moz-transform 0.5s,opacity 0.3s 0.3s;
...
.csstransformspreserve3d .bookshelf figure.open .cover{
    ...
    -o-animation:openSmallBook 0.5s forwards;
    -moz-animation:openSmallBook 0.5s forwards;
    -ms-animation:openSmallBook 0.5s forwards;
...
.csstransformspreserve3d .bookshelf figure.close .cover{
    ...
    -o-animation:closeSmallBook 0.5s forwards;
    -ms-animation:closeSmallBook 0.5s forwards;
    -moz-animation:closeSmallBook 0.5s forwards;
    animation:closeSmallBook 0.5s forwards
}
.bookshelf figure.open .book{
    z-index:1000;
    -webkit-animation:scaleUpSmallBook 0.5s forwards;
    -ms-animation:scaleUpSmallBook 0.5s forwards;
    -o-animation:scaleUpSmallBook 0.5s forwards;
    -moz-animation:scaleUpSmallBook 0.5s forwards;
    animation:scaleUpSmallBook 0.5s forwards
}
.bookshelf figure.close .book{
    -webkit-animation:scaleDownSmallBook 0.5s forwards;
    -o-animation:scaleDownSmallBook 0.5s forwards;
    -moz-animation:scaleDownSmallBook 0.5s forwards;
    -ms-animation:scaleDownSmallBook 0.5s forwards;
...
.bb-custom-wrapper.showen{
    ...
    -ms-animation:openBigBook 0.5s forwards;
    -moz-animation:openBigBook 0.5s forwards;
    -ms-animation:openBigBook 0.5s forwards;
    animation:openBigBook 0.5s forwards
}
.no-cssanimations .bb-custom-wrapper.showen{
    opacity:1
}
.bb-custom-wrapper.hiden{
    -webkit-animation:closeBigBook 0.5s forwards;
    -moz-animation:closeBigBook 0.5s forwards;
    -o-animation:closeBigBook 0.5s forwards;
    -ms-animation:closeBigBook 0.5s forwards;
    animation:closeBigBook 0.5s forwards
}
.no-cssanimations .bb-custom-wrapper.hiden{
    opacity:0
}
.bookshelf figure{
    z-index:100;
...
.csstransformspreserve3d .details-open .book{
    ...
    -o-transform:translateX(-36px) rotateY(90deg);
    -moz-transform:translateX(-36px) rotateY(90deg);
    -ms-transform:translateX(-36px) rotateY(90deg);
...
.details-open .details{
    ...
    -ms-transition:opacity 0.5s,visibility 0s;
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="section-title text-center">
            ...
            <h2> <span class="text-orange padin_rt">Welcome to</span>Lugma</h2>
...
<section class="special-menu parallax" style="background-image: url(assets/images/bg.jpg);">
  <div class="page-section-ptb">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12">
...
<section class="our-menu page-section-pt parallax pb-30" style="background-image: url();">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
...
<footer class="footer" style="background-image: url(assets/images/bg.jpg);">
    ...
    <div class="container">
      <div class="row">
        <div class="co-lg-12 co-md-12 col-sm-12 col-xs-12 text-center">
          ...
          <p class="text-white mt-30"> &copy;Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> All right reserved by The Lugma.<a href="#"> </a></p>
        </div>
      </div>
    </div>
  </div>
...
.tabs ul.tabs-link { overflow: hidden; margin: 0; padding: 0px; margin-bottom: 80px;padding-top:50px; }
...
.tabs ul.tabs-link li a { color: #333; font-weight: bold; }
...
.menu-body.menu-left .menu-title { display: block; border-bottom: 1px dashed #d41010; padding-bottom: 10px; }
