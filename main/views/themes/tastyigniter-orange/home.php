    ...
    <div class="content-wrap">
                                ...
                                <div>
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <ul class="location_list">
                                            ...
                                            <li class="text-muted"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Offers delivery only, pick-up is not available.
                                            </li>
                                            <li class="text-muted"><i class="fa fa-motorcycle"></i> Delivery in <b><?php echo $restaurant['delivery_time']; ?></b> minutes
                                            </li>
                                            <li class="text-muted "><span class="fa fa-suitcase" aria-hidden="true"></span> Pick-up in <b>30</b> minutes
                                            </li>
     ...
     ?>
            ...
            <div class="col-sm-8 nopad">
                <div id="map_home" class="slideInUp map_head" style="height:400px; width:100%"></div>
            </div>
            <div class="clearfix"></div>
