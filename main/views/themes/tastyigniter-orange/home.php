...
<script>
                        ...
                        var markers = new Array();
                            ...
                            var local_res = [];
                            resta.forEach(value => {
                                var map = [new google.maps.LatLng(value['location_lat'], value['location_lng']), 'Marker 1','<div><strong>'+value['location_name']+'</strong></div>\
                            ...
                            for (var i = 0; i < locations.length; i++) {
                                ...
                                var marker = new google.maps.Marker({
                                    ...
                                    icon: "assets/images/map-icon/map-icon.png",
                                    map: map,
                                    title: locations[i][1],
                                });
