...
$theme['head_tags'] = array(
	...
	'style'    	=> array(
		...
		array(theme_url('tastyigniter-orange/slide/css/owl.carousel.min.css'), 'owl.carousel-css', '20'),
		array(theme_url('tastyigniter-orange/slide/css/owl.theme.default.min.css'), 'owl.theme.default.min', '26'),
	...
	'script'   	=> array(
		...
		array(theme_url('tastyigniter-orange/slide/js/jquery.counterup.min.js'), 'counterup-js', '11'),
