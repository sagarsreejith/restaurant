        ...
        <body class="<?php echo $body_class; ?>">
                                        ...
                                        <form method="POST" accept-charset="utf-8" action="" role="form" class="">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" id="first-name" class="form-control input-lg" value="<?php echo set_value('fullname'); ?>" name="first_name" placeholder="<?php echo lang('label_first_name'); ?>" autofocus="">
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-md-6">
                                                            <button type="submit" class="btn btn-primary btn-block btn-lg" onclick="register()">
            ...
            <script>
                ...
                function register() {
                    ...
                    if (registerValidate(first - name, telephone, email, password, password - confirm) == false) {
                        return false;
                    }
                    $.ajax({
                        url: js_site_url('register'),
                        type: 'POST',
                        data: 'first-name=' + first - name + 'telephone' + telephone + 'email=' + email + '&password=' + password + '&password-confirm' + password - confirm,
                        dataType: 'json',
                        success: function(json) {
                            if (json['success'] == true) {
                                $(location).attr('href', js_site_url('account/account'));
                ...
                function registerValidate(first - name, telephone, email, password, password - confirm) {
                    var isValid = true;
